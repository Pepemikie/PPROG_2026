...
CFLAGS_DEBUG=-Wall -g -pedantic -ansi -DDEBUG
LIBS= -lscreen -L. 
...
OBJ_DEBUG = command_d.o game_d.o game_actions_d.o game_loop_d.o space_d.o graphic_engine_d.o game_reader_d.o object_d.o player_d.o character_d.o set_d.o
